    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center py-4 px-10 gap-6">
        ...
        <input
          ...
          className="py-3 px-3 text-3xl text-white bg-black rounded-full w-[1200px] ml-auto"
          value={title}
      ...
      <div className="flex items-start py-4 px-10 gap-6">
        ...
        <textarea
          ...
          className="w-[1200px] h-[270px] text-2xl text-white bg-black rounded px-3 py-2 ml-auto"
          value={content}
      ...
      <div className="flex justify-between px-10 py-4 gap-4">
        <button
          className="px-6 py-2 text-3xl text-white bg-black rounded cursor-pointer"
